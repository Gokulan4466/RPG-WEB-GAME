...
export default function DashboardPage() {
  ...
  const fetchTodaysQuests = useCallback(async () => {
    ...
    if (res.success && res.data) {
      setTodaysQuests(res.data.slice(0, 5)); // Show top 5 active quests
    }
  ...
  const handleCompleteQuest = async (questId: string) => {
    ...
    if (res.success && res.data) {
      ...
      // Update character state globally
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card variant="gold" className="lg:col-span-2 space-y-6 relative overflow-hidden">
          ...
          {/* Core Attribute Grid Quick Glance */}
        ...
        <Card variant="purple" className="space-y-4 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/dashboard/stats" className="text-xs text-purple-300 hover:underline flex items-center">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/dashboard/quests" className="text-xs text-amber-400 hover:underline font-semibold flex items-center gap-1">
